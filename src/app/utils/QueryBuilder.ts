...
async execute(): Promise<IQueryResult<T>> {
  // ১. কাউন্ট করার জন্য একদম ক্লিন হোয়্যার অবজেক্ট (যাতে select না থাকে)
  const countWhere = this.countQuery && this.countQuery.where ? this.countQuery.where : {};

  const [total, data] = await Promise.all([
    // ২. প্রিজমার ইন্টারনাল এরর এড়াতে 'as any' কাস্টিং ব্যবহার
